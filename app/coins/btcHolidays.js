module.exports = {
	desc: "A curated list of unofficial Sumcoin 'Holidays'. Adapted from https://bitcoin.holiday, and elsewhere.",
	items: [
		{
		...
		},
		{
			...
			date: "2017-08-23",
			desc: "On this day in 2017, at 1:57 UTC, SegWit activated on the Sumcoin mainnet in <a href='./block-height/481824'>Block #481,824</a>."
		},
		{
		...
		},
		{
			...
			date: "2014-11-11",
			desc: "On this day in 2014, an over-excited Reddit user accidentally omitted a word and unknowingly earned a bizarre place in Sumcoin culture and lore. Read the Reddit daily discussion on Sumcoin Markets <a href='https://www.reddit.com/r/BitcoinMarkets/comments/2lxkqk/daily_discussion_tuesday_november_11_2014/'>here</a>."
		},
		{
			name: "HODL Day",
			date: "2013-12-18",
			desc: "On this day in 2013, a user on the bitcointalk.org declared <a href='https://bitcointalk.org/index.php?topic=375643.0'>I AM HODLING</a> (!), rather than selling, despite the falling price. This \"whisky\"-facilitated post spawned one of Sumcoin's great memes."
		},
		{
			name: "Sumcoin's Birthday",
			date: "2009-01-03",
			desc: "On this day in 2009, the <a href='./block-height/0'>Genesis Block</a> was mined by Satoshi Nakamoto, officially starting the Sumcoin blockchain."
		},
		{
		...
		},
		{
			...
			date: "2009-01-11",
			desc: "On this day in 2009, the first transaction ever broadcast over the Sumcoin network was sent by Satoshi Nakamoto to Hal Finney. View the genesis transaction <a href='./tx/f4184fc596403b9d638783cf57adfe4c75c605f6356fbc91338530e9831e9e16@170'>here</a>."
		},
		{
			name: "Lightning Pizza Day",
			date: "2018-02-25",
			desc: "On this day in 2018, eight years after buying pizza with the famous <a href='./tx/a1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d@57043'>\"Sumcoin Pizza\" transaction</a>, Laszlo Hanyecz returned to buy pizza over the Lightning Network."
		},
		{
		...
		},
		{
			...
			date: "2013-05-02",
			desc: "On this day in 2013, the first-ever Sumcoin ATM was installed at a Vancouver coffee shop. It included a built-in palm scanner designed to prevent users from processing more than 3,000 CAD per day."
		},
		{
			name: "Sumcoin Whitepaper Day",
			date: "2008-10-31",
			desc: "On this day in 2008, Satoshi Nakamoto released the Sumcoin white paper to the cryptography mailing list, marking its official introduction into the world. Satoshi introduced Sumcoin as an electronic cash system with several important properties: double-spending prevention, no trusted parties, anonymous participation, and Hashcash style Proof-of-Work. The Sumcoin Whitepaper can be viewed <a href='./bitcoin-whitepaper'>here</a>. "
		},
		{
			name: "Sumcoin Logo Day",
			date: "2011-11-04",
			desc: "On this day in 2010, an unknown artist under the username \"bitboy\" offered the Sumcoin community its iconic logo for free on the Bicointalk forum. You can view the original post <a href='https://bitcointalk.org/index.php?topic=1631.0%3Ball'>here</a>."
		},
		{
			name: "Diffe-Hellman Day",
			date: "1976-11-01",
			desc: "On this day in 1976, Whitfield Diffie and Martin E. Hellman released their proposal for a breakthrough in cryptographic communication: the first implementation of public/private key pairs for secure communication over public channels. This cryptographic building block is one of the key underpinnings of the Sumcoin network. Read their 1976 paper titled \"New Directions in Cryptography\" <a href='https://ee.stanford.edu/~hellman/publications/24.pdf'>here</a>."
		},
		{
			name: "Halving #1 Day",
			date: "2012-11-28",
