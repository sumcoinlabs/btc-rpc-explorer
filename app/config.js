...
module.exports = {
	...
	/* 13 */	{name:"Whitepaper Extractor", url:"./bitcoin-whitepaper", desc:"Extract the Sumcoin whitepaper from data embedded within the blockchain.", iconClass:"bi-file-earmark-text"},
	...
	/* 17 */	{name:"Quotes", url:"./quotes", desc:"Curated list of Sumcoin-related quotes.", iconClass:"bi-chat-quote"},

	/* 18 */	{name:"UTXO Set", url:"./utxo-set", desc:"View the latest UTXO Set.", iconClass:"bi-list-columns"},

	/* 19 */	{name:"Holidays", url:"./holidays", desc:"Curated list of Sumcoin 'Holidays'.", iconClass:"bi-calendar-heart"},
