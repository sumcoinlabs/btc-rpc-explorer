module.exports = {
	...
	"routes":[
		...
		// blockchain
		{
			...
			"desc":"Returns the current supply of Sumcoin. An estimate using a checkpoint can be returned in 2 cases: on 'slow' devices, and before the UTXO Set snapshot is loaded."
		},
		{
			"category":"blockchain",
		...
		// mempool
		{
			"category":"mempool",
			"url":"/mempool/count",
			"desc":"Returns the number of transactions in Sumcoin Core's mempool."
		},
		{
			"category":"mempool",
			"url":"/mempool/summary",
			"desc":"Returns a summary of Sumcoin Core's mempool (full output from 'getmempoolinfo')",
		...
		},
		{
			"category":"price",
			"url":"/price/marketcap",
			"desc":"Returns the market cap of Sumcoin, in USD, EUR, GBP, XAU",
		},
		{
			"category":"price",
			"url":"/price/sats",
		...
		// fun
		{
			"category":"fun",
			"url":"/quotes/all",
			"desc":"Returns the full curated list of Sumcoin quotes.",
		},
		{
			"category":"fun",
			"url":"/quotes/$INDEX",
			"desc":"Returns the Sumcoin quote with the given index from the curated list.",
			"testUrl": "/quotes/0"
		},
		{
			"category":"fun",
			"url":"/quotes/random",
			"desc":"Returns a random Sumcoin quote from the curated list."
		},
		{
			"category":"fun",
			"url":"/holidays/all",
			"desc":"Returns the full curated list of Sumcoin Holidays."
		},
		{
			"category":"fun",
			"url":"/holidays/today",
			"desc":"Returns the Sumcoin Holidays celebrated 'today' (i.e. at the time the API call is made).",
			"optionalParams": {
		...
		},
		{
			"category":"fun",
			"url":"/holidays/$DAY",
			"desc":"Returns the Sumcoin Holidays celebrated on the specified day, using one of the following formats: yyyy-MM-DD, MM-DD.",
